...
// once routes are set up comment out these 2 lines
// app.get("/api/hello", (req,res)=>{
//     res.json({msg: "Hello mongoose Exam!!!"})
// })

require('./server/routes/pet.route')(app);  //-- this gets coded in once routes have been set up.UPDATE correct route
